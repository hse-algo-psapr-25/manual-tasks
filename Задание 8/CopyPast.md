...
Данная задача является ленточной по постановке:
1. Количество заданий произвольно (в данном случае 6);
...
5. Количество исполнителей произвольно (в данном случае 4), но не меняется в ходе выполнения заданий;
...
```mermaid
gantt
    title Диаграмма Ганта - Ленточная стратегия для 4 исполнителей и 6 задач с временем выполнения (3, 7, 7, 4, 6, 9)
    dateFormat  HH:mm    
    axisFormat %H:%M
    Начало выполнения работ : milestone, m1, 00:00, 0h
    section Исполнитель 1
    Задача A         :a1, 00:00, 3h
    Задача B         :a2, 03:00, 6h
    section Исполнитель 2
    Задача B         :b1, 00:00, 1h
    Задача C         :b2, 01:00, 7h
    Задача D         :b3, 08:00, 1h
    section Исполнитель 3
    Задача D         :c1, 00:00, 3h
    Задача E         :c2, 03:00, 6h
    section Исполнитель 4
    Задача F         :d1, 00:00, 9h
    Окончание выполнения работ : milestone, m2, 09:00, 0h
```
Время выполнения **9 ед**
