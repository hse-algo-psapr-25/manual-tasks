...
В остаточной сети найден ориентированный цикл отрицательной стоимости s -> b -> d -> с -> a -> s (- 1 - 7 + 5 + 1 + 1 = -1). 

<img width="1550" height="511" alt="image" src="https://github.com/user-attachments/assets/be83a781-a0a9-4f56-8eaf-e6be72acd582" />

Найдем минимальный вес ребра в указанном цикле, изображенном **в остаточной сети с указанием величины потока**.  

<img width="2176" height="617" alt="image" src="https://github.com/user-attachments/assets/42e678b7-e497-404c-b029-9aa2ae20b94f" />
...
|:----------------------------------------------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:-----:|
| Пропускная способность p(e)                   | 10 | 10 | 6  | 6  | 6  | 12 | 6  | 15 | 5  |       |        
| Локальный поток f(e)                          | 10 | 5  | 0  | 6  | 4  | 9  | 6  | 15 | 5  |       |     
| Стоимость транспортировки единицы потока c(e) | 1  | 1  | 1  | 3  | 1  | 5  | 7  | 1  | 5  |       |
| Суммарная стоимость f(e)*c(e)                 | 10 | 5  | 0  | 18 | 4  | 45 | 42 | 15 | 5  | 144   | 

Стоимость полученного потока составляет 145. 

### Ответ:
Максимальный поток в сети равен 15, минимальная стоимость потока 145, она реализуется следующим локальными потоками:

<img width="719" height="359" alt="image" src="https://github.com/user-attachments/assets/21d75a04-45b0-4f97-8d0b-34f7be0cf2b6" />
