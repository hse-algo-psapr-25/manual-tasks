...
Задания A и B объединяются и выполняются совместно исполнителями 1 и 2 с равным разделением времени, а также объединятся D и E
