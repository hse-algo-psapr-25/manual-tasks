...
В строке E видим отсутствие нулей, поэтому проведём повторную редукцию по одной этой строке.
...
В ячейках C1, C4 появились новые нулевые значения, добавим соответствующие рёбра в двудольный граф.
...
### Шаг 6. Попытаемся построить совершенное паросочетание с помощью чередующихся деревьев снова из непокрытой вершины E
