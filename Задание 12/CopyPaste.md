...
Распределение работ для диаграммы:
- Исполнитель 1 ($p=6$): 2ч на A, 2ч на B
- Исполнитель 2 ($p=4$): 3ч на C, 1ч на D
- Исполнитель 3 ($p=2$): 4ч на D
...
Распределение работ для диаграммы:
- Исполнитель 1 ($p=6$): Выполнит 30 ед. объема. (A: 12, B: 12, C: 6) $\to$ A(2ч), B(2ч), C(1ч).
- Исполнитель 2 ($p=4$): Выполнит 20 ед. объема. (C: 6, D: 12, E: 2) $\to$ C(1.5ч), D(3ч), E(0.5ч).
- Исполнитель 3 ($p=2$): Выполнит 10 ед. объема. (E: 10) $\to$ E(5ч).
