...
----
Согласно графу, в вершину А можно попасть:
  - из точки А - одним способом;
  - из точки B - двумя способами.

В вершину B можно попасть:
  - из точки B - одним способом.

В вершину С можно попасть:
  - из точки А - одним способом;
  - из точки B - одним способом;
  - из точки С - одним способом.
...
Таким образом, $a_n \equiv 1$, то есть в указанном графе существует только один маршрут, который начинается и заканчивается в вершине А - это проход по петле. Маршруты из А в А разной длины $n$ будут отличаться только количеством проходов по этой петле.
