...
|----|:------------------------------------|:--------------|:------------------------------:|
| 1  | s                                   | a, b, c, d, t |         4 + 6 + 8 = 18         |
|    | **s + одна вершина из a, b, c, d**  |               |                                |
| 2  | s, a                                | b, c, d t     |         8 + 4 + 4 = 16         |
| 3  | s, b                                | a, c, d t     |         8 + 4 + 6 + 9 = 27     |
| 4  | s, c                                | a, b, d t     |         8 + 6 + 5 + 3 = 22     |
| 5  | s, d                                | a, b, c t     |         4 + 6 + 2 + 5 = 17     |
|    | **s + пара вершин из a, b, c, d**   |               |                                |
| 6  | s, a, b                             | c, d, t       |         8 + 4 + 9 = 21         |
| 7  | s, a, c                             | b, d, t       |         8 + 4 + 5 + 3 = 20     |
| 8  | s, a, d                             | b, c, t       |         4 + 2 + 5 + 4 = 15     |
| 9  | s, b, c                             | a, t          |         8 + 6 + 9 + 3 = 26     |
| 10 | s, b, d                             | a, t          |         4 + 6 + 2 + 5 + 9 = 26 |
| 11 | s, c, d                             | a, t          |         6 + 5 + 5 + 3 = 19     |
|    | **s + четыри вершины из a, b, c, d**|               |                                |
| 12  | s, a, b, c                         | d, t          |         8 + 3 + 9 = 20         |
| 13  | s, a, b, d                         | c, t          |         4 + 2 + 5 + 9 = 20     |
| 14  | s, a, c, d                         | b, t          |         4 + 5 + 3 + 5 + 9 = 26 |
| 15  | s, b, c, d                         | a, t          |         6 + 9 + 5 + 3 = 23     |
| 15  | s, a, b, c, d                      | t             |         5 + 3 + 9 = 17         |


Минимальная пропускная способность разреза равна 15, что совпадает с найденной величиной максимального потока в сети.

### Ответ:
Максимальный поток в сети равен 15, он реализуется следующим локальными потоками:

<img width="730" height="618" alt="image" src="https://github.com/user-attachments/assets/83f49b9e-a430-4d48-b781-c3cc4f45c7c5" />
