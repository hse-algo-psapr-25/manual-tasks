...
$$
12 + 8 + 10 + 5 + (21 - 4 - 4 - 10 - 10) * 0.25 = 35 - 7 * 0.25  Получили отрицательное значение, что значит предмет не поместится в рюкзак. Соответственно от этой вершины мы не будем продолжать поиск.
$$
...
$$
12 + 8 + 10 + 5 + (21 - 4 - 4 - 10 - 10) * 0 = 35 - 7 * 0  Получили отрицательное значение, что значит предмет не поместится в рюкзак. Соответственно от этой вершины мы не будем продолжать поиск.
$$
...
В рюкзак пойдут предметы B, E, A. Максимальная стоимость рюкзака: 4 + 4 + 10 = 18.