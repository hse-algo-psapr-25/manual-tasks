...
graph LR
    ...
    linkStyle 0,1,13 stroke:red,stroke-width:2px
```
...
|:----------------------------------------------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:------:|
| Пропускная способность p(e)                   | 18 | 5  | 6  | 10 | 5  | 4  | 3  | 8  | 4  | 5  | 12 |        |
| Локальный поток f(e)                          | 18  | 5  | 6  | 7  | 5  | 3  | 1  | 8  | 3  | 5  | 12 |        |
| Стоимость транспортировки единицы потока c(e) | 1   | 2  | 3  | 2  | 1  | 1  | 1  | 2  | 3  | 8  | 8  |        |
| Суммарная стоимость f(e)*c(e)                 | 18 | 10 | 18  | 14  | 5 | 3  | 1  | 16  | 9  | 40  | 96  | **230** |

Стоимость полученного потока составляет . 
...
В остаточной сети найден ориентированный цикл отрицательной стоимости d -> t -> c -> d (- 8 + 3 + 1 = -4).
...
graph LR
    ...
    linkStyle 1,2,3 stroke:red,stroke-width:2px
```
...
graph LR
    ...
    linkStyle 2,3,4 stroke:red,stroke-width:2px
```

Минимальный вес ребра в цикле 1 - это неиспользованный резерв ребра t -> c.
...
Ответ:
Максимальный поток в сети равен 23, минимальная стоимость потока 226, она реализуется следующими локальными потоками:
